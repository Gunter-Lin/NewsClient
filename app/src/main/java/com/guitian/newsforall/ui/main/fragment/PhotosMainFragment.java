package com.guitian.newsforall.ui.main.fragment;
...
import com.guitian.newsforall.ui.news.activity.PhotosDetailActivity;
import com.guitian.newsforall.ui.news.contract.PhotoListContract;
import com.guitian.newsforall.ui.news.model.PhotosListModel;
import com.guitian.newsforall.ui.news.presenter.PhotosListPresenter;
import com.guitian.common.base.BaseFragment;
        ...
        adapter=new CommonRecycleViewAdapter<PhotoGirl>(getContext(),R.layout.item_photo) {
            ...
            public void convert(ViewHolderHelper helper,final PhotoGirl photoGirl) {
                ...
                Glide.with(mContext).load(photoGirl.getUrl())
                        ...
                        .placeholder(com.guitian.common.R.drawable.ic_image_loading)
                        .error(com.guitian.common.R.drawable.ic_empty_picture)
